...
class HeroesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference("Hero.count") do
      post heroes_url, params: { hero: { ancestry_id: @hero.ancestry_id, category: @hero.category, name: @hero.name, pronouns: @hero.pronouns, role_id: @hero.role_id } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { ancestry_id: @hero.ancestry_id, category: @hero.category, name: @hero.name, pronouns: @hero.pronouns, role_id: @hero.role_id } }
