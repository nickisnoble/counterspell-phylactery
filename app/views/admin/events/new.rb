...
class Views::Admin::Events::New < Views::Base
  ...
  def view_template
    ...
    div(class: "md:w-2/3 w-full mx-auto") do
      ...
      link_to("Back to events", admin_events_path, class: "w-full sm:w-auto text-center mt-4 rounded-md px-3.5 py-2.5 bg-gray-100 hover:bg-gray-50 inline-block font-medium")
    end
  end
end
