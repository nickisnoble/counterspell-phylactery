...
class Views::Dashboard::Events::Edit < Views::Base
  ...
  def view_template
    ...
    div(class: "md:w-2/3 w-full mx-auto") do
      ...
      div(class: "mt-4") do
        link_to("Back to events", dashboard_events_path, class: "rounded-md px-3.5 py-2.5 bg-gray-100 hover:bg-gray-50 inline-block font-medium")
      end
    end
  end
end
